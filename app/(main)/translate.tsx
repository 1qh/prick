          ...
          <Button
            ...
            <span
              className={cn(
                ...
                'scale-[2.1] rounded-full transition-all duration-500 group-hover:scale-0'
              )}
            />
            <GlobeIcon className='absolute size-6 scale-0 transition-all duration-300 group-hover:scale-100' />
          </Button>
        </DropdownMenuTrigger>
      </Tutip>
      <DropdownMenuContent
